...
func init() {
	...
	diagnostics.Message_Set_code(Single_file_component_can_contain_only_one_script_setup_element, 1000000)
	...
	diagnostics.Message_Set_code(Single_file_component_can_contain_only_one_template_element, 1000001)
	...
	diagnostics.Message_Set_code(Single_file_component_can_contain_only_one_script_element, 1000002)
	...
	diagnostics.Message_Set_code(X_0_has_no_adjacent_v_if_or_v_else_if, 1000003)
	...
	diagnostics.Message_Set_code(Elements_cannot_have_multiple_X_0_with_the_same_name, 1000004)
	...
	diagnostics.Message_Set_code(Multiple_conditional_directives_cannot_coexist_on_the_same_element, 1000005)
	...
	diagnostics.Message_Set_code(X_0_is_missing_expression, 1000006)
	...
	diagnostics.Message_Set_code(Duplicate_X_0_call, 1000007)
	...
	diagnostics.Message_Set_code(Slot_does_not_belong_to_the_parent_component, 1000008)
	...
	diagnostics.Message_Set_code(Duplicate_model_name_X_0, 1000009)
